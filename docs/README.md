...
How short-lived CA-signed SSH user certificates replace long-lived `authorized_keys`, and why principals beat keys for cross-user denial. Pairs with `follow-along/04-ssh-certs.md`.
